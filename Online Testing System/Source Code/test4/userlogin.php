<html>
 ...
 <body>
  ...
  <div id="section">
  <h1>User Login</h1>
   <form action="http://localhost/phpbatch/test4/uservalidation.php" method="post">
    <table>
	 <tr>
	  <td>Username</td>
	 ...
	 <tr>
	  <td><a href="http://localhost/phpbatch/test4/registration.php">new user</a></td>
